...
const initialInvitation = { eventKind: "wedding", templateId: "", heroPresetId: "", rsvpEnabled: true, guestbookEnabled: true, eventTitle: "", hostName: "", person1Name: "", person2Name: "", childName: "", parent1Name: "", parent2Name: "", birthDate: "", dueDate: "", age: "", anniversaryYears: "", organizationName: "", programName: "", coverPhotoUrl: "", 
groom: "",
groomFatherName: "",
...
export default function CreateInvitation() {
  ...
  const composedTemplateRender=selectedHero?{config:templateRender.config?{...templateRender.config,hero:{...templateRender.config.hero,...selectedHero.config,frameAssetId:selectedHero.assets?.hero_frame?.id||null}}:templateRender.config,assets:selectedHero.assets?.hero_frame?.url?{...templateRender.assets,[selectedHero.assets.hero_frame.id]:selectedHero.assets.hero_frame.url}:templateRender.assets}:templateRender;
