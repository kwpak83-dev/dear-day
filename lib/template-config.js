...
function normalizeButtonStyle(value) {
  ...
  return Object.values(normalized).every((item) => item !== null) ? { ...normalized, background: color(value.background) || null, text: color(value.text) || null, syncQuickMenu: value.syncQuickMenu === true } : null;
}
