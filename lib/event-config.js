...
const checkbox = (key, label) => ({ key, label, type: "checkbox", required: false });
...
[
  text("groomFatherName", "신랑 아버지 성함"),
  checkbox("groomFatherDeceased", "故")
],
[
  text("groomMotherName", "신랑 어머니 성함"),
  checkbox("groomMotherDeceased", "故")
],
[
  text("brideFatherName", "신부 아버지 성함"),
  checkbox("brideFatherDeceased", "故")
],
[
  text("brideMotherName", "신부 어머니 성함"),
  checkbox("brideMotherDeceased", "故")
],
    ]),
